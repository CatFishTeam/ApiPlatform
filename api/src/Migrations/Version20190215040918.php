 ...
 */
final class Version20190215040918 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_account ALTER lastname DROP NOT NULL');
        $this->addSql('ALTER TABLE user_account ALTER firstname DROP NOT NULL');
        $this->addSql('ALTER TABLE user_account ALTER password SET NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_account ALTER lastname SET NOT NULL');
        $this->addSql('ALTER TABLE user_account ALTER firstname SET NOT NULL');
        $this->addSql('ALTER TABLE user_account ALTER password DROP NOT NULL');
    }
}
